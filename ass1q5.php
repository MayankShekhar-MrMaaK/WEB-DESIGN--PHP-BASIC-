...
<!--header of the page -->
<div class="header"><h3>Number System Conversion</h3></div>

<!--First Dropdownlist for Decimal-->
<div class="dropdown ">
 <button class="dropbtn topnav">Decimal</button>
 <div class="dropdown-content ">
 <a href="ass1q5.php"><input type="submit" name="oper" value="dec1">decimal to binary</input> </a><br>
 <a href="ass1q5.php"><input type="submit"name="oper" value="dec2">decimal to octal</input><br></a>
 <a href="ass1q5.php"><input type="submit"name="oper" value="dec3">decinal to hexadecimal</input></a><br>
 </div></div>
...
<div class="dropdown ">
 ...
 <div class="dropdown-content">
 <a href="ass1q5.php"><input type="submit"name="oper" value="bin1">binary to decimal</input><br></a>
 <a href="ass1q5.php"><input type="submit"name="oper" value="bin2">binary to octal</input><br></a>
 <a href="ass1q5.php"><input type="submit"name="oper" value="bin3">binary to hexadecimal</input><br></a>
 </div></div>
 ...
 <div class="dropdown-content">
 <a href="ass1q5.php"><input type="submit"name="oper" value="oct1">octal to decimal</input><br></a>
 <a href="ass1q5.php"><input type="submit"name="oper" value="oct2">octal to binary</input><br></a>
 <a href="ass1q5.php"><input type="submit"name="oper" value="oct3">octal to hexadecimal</input><br></a>
 </div></div>
 ...
 <div class="dropdown-content">
 <a href="ass1q5.php"><input type="submit"name="oper" value="hex1">hexadecimal to decimal</input><br></a>
 <a href="ass1q5.php"><input type="submit"name="oper" value="hex2">hexadecimal to binary</input><br></a>
 <a href="ass1q5.php"><input type="submit"name="oper" value="hex3">hexadecimal to octal</input><br></a>
 </div></div>
