...
<h1 style="color:white;font-size:100%;">Enter the number saperated by COMMAS (,)
	<form method="post">
		<input type="text" name="numbers"/><br>
		<input type="radio" name="m" value="MAXIMUM">MAXIMUM<br>
		<input type="radio" name="m" value="MINIMUM">MINIMUM<br>
...
<body>
	...
	if(isset($_POST['submit']))
	{
		...
		switch($ch)
		{
			case 'MAXIMUM':
			{
				echo "Maximum Number is: $largest <br />";
				break;
			}
			case 'MINIMUM':
			{
				echo "Minimum Number is: $smallest</br>";
				break;
			}
		}
	}
